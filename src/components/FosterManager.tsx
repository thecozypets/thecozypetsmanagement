                      ...
                      return (
                        <>
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <Badge className={`text-xs font-bold uppercase ${f.paymentStatus === 'paid' ? 'bg-success text-success-foreground' : f.paymentStatus === 'partly-paid' ? 'bg-warning text-warning-foreground' : 'bg-destructive text-destructive-foreground'}`}>
                              {f.paymentStatus}
                            </Badge>
                            {f.paymentMethod && <span className="text-xs uppercase font-bold text-foreground bg-muted px-2 py-0.5 rounded">{f.paymentMethod}</span>}
                          </div>
                        </>
                      );
                    })()}
